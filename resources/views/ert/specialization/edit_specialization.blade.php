...
<div class="container pt-4 px-4" style="margin-left:120px;">
    <h4 class="main-title p-4">Edit Specialization</h4><br>

        <div class="row gx-5">

            <div class="col-md-4">
                <label for="zone_name" class="form-label" id="z"> Specialization*</label>
                <input type="text" name="zone" id="zone" class="form-control" placeholder="Enter Specialization" value="{{ $specialization->specialization }}">
            </div>
            <div class="col-md-4" style="margin-right: 100px; margin-top: -5px;">
                ...
                <div class="form-floating" style="width: 500px;">
                    <textarea class="form-control" name="details" placeholder="Enter Details" id="floatingTextarea">{{ $specialization->details }}</textarea>
        ...
        <div class="row">
            ...
            <a href="{{ route('specialization.edit', ['id' => $specialization->id]) }}">Edit</a>
            </a>
            <div class="col-md-2 ml-auto">
                <button type="button" class="btn btn-success" style="margin-top:40px; margin-left:800px;">Update</button>
            </div>
        </div>
    </form>
</div>
